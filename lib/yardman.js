...
function printHelp(stdout) {
  ...
  write('  -d, --debounce=ms        Set the number of milliseconds to wait for before');
  write('                           executing the command after a file change. Useful');
  write('                           when switching branches while watching files.');
  write('');
  write('Variables:');
